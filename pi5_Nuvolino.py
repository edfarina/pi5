...
try:
    global db
    db = MySQLdb.connect(host="sql11.freesqldatabase.com",    # your host, usually localhost
...
class compteurlayout(GridLayout):
    def __init__(self, **kwargs):
        ...
        global conn_status, state_of_charge, grid_power, state, battery_alarm, battery_current, battery_voltage
        state_of_charge = 0
        state = 0
        battery_alarm = 0
        battery_current = 0
    ...
    def cyclic_compteur(self,dt): # cyclique d'affichage
...
class MyApp(App):
    ...
    def cyclic(self,dt):
        global energie,Pinst, conn_to_ccgx, seconds, conn_status, time_check, state_of_charge, grid_power, state, battery_alarm, battery_voltage, battery_current
...
#rr = client.read_holding_registers(2700, 3, unit=0)
        ...
        try:
            ...
            cur.execute('INSERT INTO sql11172989.Nuvolino ' + 
